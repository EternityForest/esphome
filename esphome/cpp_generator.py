...
async def process_lambda(
    ...
    """
    from esphome.components.globals import GlobalsComponent, RestoringGlobalsComponent, RestoringGlobalStringComponent
    ...
    for i, id in enumerate(value.requires_ids):
        ...
        if (
            ...
            and (
                ...
                or full_id.type.inherits_from(RestoringGlobalsComponent) or
                full_id.type.inherits_from(RestoringGlobalStringComponent)
            )
        ):
